...
echo'<input type=button value=Search onClick="department();">';
echo'</td></tr>';
...
window.open("bio_incidentdepartment.php?ticketno="+ticket,"department","toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=1300,height=600,left=0,top=0");
}
