...
and bio_leads.leadstatus not in (20)";
  ...
  if(isset($_SESSION['Actiondate']) ||  isset($_SESSION['task']) || isset($_SESSION['byplace']) || isset($_SESSION['byname']) || isset($_SESSION['phone'])) 
 {
    ...
    if ($_SESSION['byname']!='')   
    $sql .=" AND bio_cust.custname LIKE '%".$_SESSION['byname']."%'";
    } 
    ...
    $sql.=" AND bio_district.district LIKE '%".$_SESSION['byplace']."%'"; 
     ...
     if (isset($_SESSION['bycode'])) {
    if ($_SESSION['bycode']!='') 
    $sql.=" AND bio_cust.debtorno LIKE '%".$_SESSION['bycode']."%'"; 
    }   
...
echo"<td class='byname'><input type='text' name='byname' id='byname' value=".$_SESSION['byname']."></td>";
echo"<td><input type='text' name='phone' id='phone' value=".$_SESSION['phone']."></td>"; 
...
/*
$sqlnew="SELECT `taskid`,`task` FROM `bio_task` WHERE `taskid` in (18,20,21,1,5,24,25,28) 
                order by taskid='28',taskid='25', taskid='24',taskid='5',taskid='1',taskid='21',taskid='20',taskid='18' ";*/
$sqlnew="SELECT `taskid`,`task` FROM `bio_task` WHERE `taskid` in (18,20,21,1,5,24,25,28)
                ORDER BY FIELD (taskid,18,20,21,1,5,24,25,28) ";
...
myRef = window.open("bio_dropleadfromtask.php?leadid=" + str1+"&taskid=18","droplead","toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=700,height=400");
    }
</script>
