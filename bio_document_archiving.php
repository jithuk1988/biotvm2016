...
echo"<tr><td>Country</td><td><select name='country' id='country' onchange='showstate(this.value)' style='width:130px'>";
...
echo"<tr><td>Year<td><input style=width:150px type='text' name='year' id='year' style='width:100px' value=".date('Y')."></td></tr>";
        echo "<tr><td>Document Location<td><input style=width:150px type='text' name='docloc' id='docloc' style='width:100px'></td></tr>";
...
if(isset($_POST['submit'])){
    $sql="SELECT a.debtorno FROM debtorsmaster1 a                                                                       WHERE  a.cid=".$_POST['country']."";
 if (isset($_POST['year']))    {
...
$sql1="UPDATE debtorsmaster1 SET docloc='".$_POST['docloc']."' WHERE debtorsmaster1.debtorno='".$row['debtorno']."'";
...
if (isset($_POST['lsgType']))    {
     ...
     if (isset($_POST['lsgName']))    {         
     if($_POST['lsgType']==1){
 $sql1="UPDATE bio_corporation1 SET docloc='".$_POST['docloc']."' WHERE bio_corporation1.country=".$_POST['country']."
                    AND bio_corporation1.state=".$_POST['state']." AND bio_corporation1.district=".$_POST['district'];
$result1=DB_query($sql1,$db);         
     }
     if($_POST['lsgType']==2)   {
 $sql1="UPDATE bio_municipality1 SET docloc='".$_POST['docloc']."' WHERE bio_municipality1.country=".$_POST['country']."
                    AND bio_municipality1.state=".$_POST['state']." AND bio_municipality1.district=".$_POST['district']."
                    AND bio_municipality1.id=".$_POST['lsgName'];
$result1=DB_query($sql1,$db);       }
    
       elseif($_POST['lsgType']==3){
 echo$sql1="UPDATE bio_panchayat1 SET docloc='".$_POST['docloc']."' WHERE bio_panchayat1.country=".$_POST['country']."
                    AND bio_panchayat1.state=".$_POST['state']." AND bio_panchayat1.district=".$_POST['district']."
                    AND bio_panchayat1.block=".$_POST['gramaPanchayath']." 
                    AND bio_panchayat1.id=".$_POST['lsgName'];
   $result1=DB_query($sql1,$db);       } 
