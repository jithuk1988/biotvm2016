...
// $pdf->addTextWrap($Left_Margin+270,$YPos-=$line_height-14,1000,$FontSize+1,$string4,'',0);
 ...
 if($annual_organic_fertilizer!=0){
    $pdf->addTextWrap($Left_Margin,$YPos-=$line_height+10,900,$FontSize+1,_('Annual income in the form of Organic fertilizer  '), 'left'); $pdf->addTextWrap($Left_Margin+300,$YPos-=$line_height-14,900,$FontSize+1,_('-'), 'left');
