...
echo'<tr><td colspan="2" id="addcom"><center><input type="submit" name="submit" id="submit" value="Add Complaint" onclick=" if(validate()==1)return false"></center></td></tr>';
...
if($_POST['history'])
{
echo "<fieldset style='width:90%; hight:auto'>";     
     echo "<legend><h3>View History</h3>";
     echo "</legend>"; 
    
          
     echo "<table style='border:1px solid ;width:70%;'>";
     echo "<tr>
        <th>Slno</th>
        <th>Ticket No</th>
        <th>Description</th> 
...
/* echo'</form>';
 if($_GET['selectOrder'])
{
    ?><script>$('#new_comp').show();</script><?php 
}else{?><script>$('#new_comp').hide();</script><?php }*/
...
// $('#dinhide').show(); 
 ...
 // alert("hvhjjvhjhvj");
xmlhttp.open("GET","bio_complaint_register_ajx.php?orderno="+orderno,true);
xmlhttp.send(); 
