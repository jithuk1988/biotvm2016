...
include('includes/header.inc');
 ...
 include('includes/sidemenu.php');    
  ...
  echo '<center><font style="color: #333;
                           ...
                           font-size:16px;
                           font-family:Georgia;
                           text-shadow: 1px 1px 1px #666;">ACTIVE LEADS</font></center>';   
...
//    echo'<td>'.$myrow3['reqno'].'</td>';
   ...
   // echo'<td>'; 
    echo '<td><a style=cursor:pointer; id='.$myrow3['leadid'].' onclick=showactive(this.id)>' . _('Select') . '</td></a>';
...
print'<script>
    function showactive(str1){
         ...
         window.location="bio_activeleads_changestatus.php?lead=" + str1;
    }
    </script>';
