...
$sql_emp1="SELECT * FROM bio_emp WHERE empid=".$empid;
 ...
 /* echo "<fieldset style='width:20%;height:440px'>";     
  ...
  echo "<fieldset style='width:90%;height:auto;'>";     
...
echo'<td class="datefrom"><input type="text"  id="datefrm" class=date alt='.$_SESSION['DefaultDateFormat']. ' name="datef" value="'.$_POST['datef'].'" onChange="return isDate(this, this.value, '."'".$_SESSION['DefaultDateFormat']."'".')'.'"'.' style="width:70px">';    


echo'<td class="dateto"><input type="text"  id="dateto" class=date alt='.$_SESSION['DefaultDateFormat']. ' name="datet" value="'.$_POST['datet'].'" onChange="return isDate(this, this.value, '."'".$_SESSION['DefaultDateFormat']."'".')'.'"'.' style="width:70px">';    
echo"</td>";  
...
//if(isset($_POST['filterbut']) or isset($_POST['next']) or isset($_POST['previous']) or isset($_POST['go']) )
if(isset($_POST['filterbut']))
...
function convertsqldatefordis($d) 
{
   ...
   include('includes/bio_search.php');
...
echo "<th width='13%'>" . _('Email Status') . "</th>";
   ...
   echo '<tr>';                                       
      ...
      $k=0; 
      $RowIndex=0;
          DB_data_seek($result,($_POST['PageOffset'] - 1) * $limit );
      while($myrow=DB_fetch_array($result)  AND ($RowIndex <> $limit))
      {   $RowIndex++;
               if ($k==1)
                {
