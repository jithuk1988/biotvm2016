...
$sum=$row1[0];
            ...
            $sql1="UPDATE bio_conceptproposal SET status = 3 WHERE lead_id =$lead_ID AND cp_id=".$proposal_ID;
    ...
    $row_sum=DB_fetch_array($result_sum);
           ...
           $sql_update="UPDATE bio_conceptproposal SET status=3 WHERE lead_id=".$lead_ID." AND cp_id=".$proposal_ID;     // status->6  previous cpid(modification made) 
