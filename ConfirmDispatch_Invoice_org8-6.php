...
foreach ($_SESSION['Items']->LineItems as $LnItm) {
  ...
  echo  $subsidy=$myrow_subsidy['amount'];    
...
echo '<input type=text name=grosssubsidy id=grosssubsidy value='.$subsidy.'>';    // $Gross_subsidy     
...
echo "<tr>
        <td>"._('Location'). ":</td>
        <td><select tabindex=".$j." name='StockLocation' id='StockLocation' onchange='showitem()'  > ";
