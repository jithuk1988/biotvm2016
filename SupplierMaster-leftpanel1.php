...
//    echo '<input type="hidden" name="CurrCode" value="INR">';
    ...
    echo '<tr><td>' . _('Company name') . "*</td><td><input type='text' id='suppliername' name='SuppName' value='".$_POST['SuppName']."' size=25 maxlength=50></td></tr>"; 
    ...
    while ($myrow = DB_fetch_array($result)) {
     ...
     if(!isset($_GET['p']))     {
         ...
         echo'<input type="hidden" id="suppselected" name="SuppSelected" value=0>'; 
     }
