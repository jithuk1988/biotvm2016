...
left join bio_plantstatus on bio_installation_status.plant_status=bio_plantstatus.id where salesorders.debtorno not like '0000' AND bio_installation_status.installed_date !='0000-00-00' and salesorders.debtorno not in (select debtorno from bio_cdmbase) "; 
...
where bio_oldorders.debtorno not like '00000' AND `bio_oldorders`.`installationdate` !='0000-00-00'  and bio_oldorders.debtorno not in (select debtorno from bio_cdmbase)
"; 
