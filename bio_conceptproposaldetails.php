...
//print_r($count);
 ...
 echo $sql1="SELECT bio_district.district 
          FROM bio_district
 ...
 ///////////////////
  $sql="SELECT bio_leads.leadid,
                   ...
                   bio_district.district,
                    ...
                    LEFT JOIN bio_outputtypes ON bio_outputtypes.outputtypeid=bio_leads.outputtypeid
                    LEFT JOIN bio_fs_entrydetails ON bio_fs_entrydetails.leadid=bio_leads.leadid
                    LEFT JOIN bio_leadteams ON bio_leadteams.teamid=bio_fs_entrydetails.teamid
                    LEFT JOIN bio_district ON bio_district.cid=bio_cust.nationality AND bio_district.stateid=bio_cust.state AND bio_district.did=bio_cust.district
...
echo"<td><input type='text' name='Contactperson' required id='contactperson' value='$contactperson' style=width:175px></td></tr>"; 

echo"<tr></tr>";
echo"<tr><td width=50%>Mobile Number</td>";
echo"<td><input type='text' name='mobile' required id='custmob' value='$mob' style=width:175px></td></tr>";

echo"<tr></tr>";
echo"<tr><td>Phone Number</td>"; 
echo"<td><input type='text' name='phone' required id='custph' value='$cph' style=width:175px></td></tr>";
