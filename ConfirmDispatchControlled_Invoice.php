...
/* $Id: ConfirmDispatchControlled_Invoice.php 4586 2011-06-02 10:12:41Z daintree $*/
...
echo '<br /><a href="'. $rootpath. '/ConfirmDispatch_Invoice.php?invoiceorderno=' . $_SESSION['Items']->OrderNo . '">'. _('Back to Confirmation of Dispatch') . '/' . _('Invoice'). '</a>';
