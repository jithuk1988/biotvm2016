...
function show_progressbar(id) {
    ...
    function lsgOrder(str1,str2)
    {
        //alert(str1);         alert(str2); 
               myRef = window.open("dealerordernew.php?custid=" + str1 + "&leadid=" + str2 + "&enquiryid=1"  ,"lsgorder","toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=700,height=400");
