...
echo '<center><font style="color: #333;
                           ...
                           font-size:16px;
                           font-family:Georgia;
                           text-shadow: 1px 1px 1px #666;">FEASIBILITY RECIEPT</font></center>'; 
    
echo "<table style='width:60%'><tr><td>";
echo "<fieldset style='width:97%;'>";     
echo "<legend><h3>Institution Customers</h3>";
echo "</legend>";
...
bio_leads,
bio_cust 
       where bio_cust.cust_id=bio_leads.cust_id and bio_leads.advanceamount!=0 and bio_leads.enqtypeid=2";
...
{
window.location="bio_fea_print_A5p.php?leadid=" + str;
}
</script>
