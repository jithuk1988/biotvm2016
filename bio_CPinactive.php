...
if(!isset($_POST['excelview'])) {
  ...
  echo '<center><font style="color: #333;
                           ...
                           font-size:16px;
                           font-family:Georgia;
                           text-shadow: 1px 1px 1px #666;">CONCEPT PROPOSAL INACTIVE LEADS</font></center>';                   
 echo "<table style='width:60%'><tr><td>";
 echo "<fieldset style='width:97%;'>";     
 echo "<legend><h3>Showing all INActive Leads of Concept Proposal</h3>";
 echo "</legend>";  
...
//       $sql7="SELECT value from bio_changepolicy where  policyname='No of Days to became CP inactive'";
 ...
 //include('includes/footer.inc');      
   ...
   print'<script>
    function showactive(str1){
         ...
         window.location="bio_reminderletter.php?lead=" + str1;
    }
    </script>';
 } 
...
$data= $data.$slno.",".$myrow3['leadid'].",".$myrow3['custname'].",".$myrow3['teamname'].",".ConvertSQLDate($myrow3['createdon']).",".$myrow3['custmob'].",".$myrow3['custmail']."\n";    $slno++;    
      }
