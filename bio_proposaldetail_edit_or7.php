<?php
 ...
 $sql1="select fp_amount from bio_fsproposal where leadid=$lead_ID and  fs_propono=$fsid";
     $result=DB_query($sql1,$db);    
  $myrow1=DB_fetch_array($result);
  
 
 $amount=$myrow1['fp_amount'];
...
echo"<td><input type='text' name='ExpectedDate' placeholder='DD/MM/YYYY' onkeypress='return noenter()' id='date' class=date alt='".$_SESSION['DefaultDateFormat']. "' style='width:135px'></td></tr>";
echo"<tr></tr>";
...
echo"</div>";
echo"</td></tr></table>";
echo '<center><input type="button" name="update" id="update" value="Modify" onClick="modify()"></center>';       
