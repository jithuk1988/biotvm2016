...
echo"<div id=insatal>";
echo"<fieldset style='width:100%;height:350px '>"; 
...
if($main['installed_date']!=NULL && $main['installed_date']!=0){
...
if($main['due_date2']!=NULL && $main['due_date2']!=0){
        $due=$main['due_date1'];
...
echo"<div id=calllog>";
echo"<fieldset style='width:85%;height:160px'>"; 
...
<th style=width:10%><b>PLANT STATUS</b></th>
<th style=width:10%><b>CLOSE STATUS</b></th>
<th style=width:10%><b>CALL NO</b></th>
<th style=width:10%><b>REMARKS</b></th></tr>";
...
if(($result_tb["due_date1"]<= $crrdate && $result_tb["actual_date1"]== 0)  || ($result_tb["due_date2"]<=$crrdate && $result_tb["actual_date2"]== 0) || ($result_tb["due_date3"]!=0 && $result_tb["due_date3"]<=$crrdate && $result_tb["close_status"]==0)) {
  ...
  if($result_cal_log['callno']==1){$callno="First Call";}
  elseif($result_cal_log['callno']==2){$callno="Second Call";}
  elseif($result_cal_log['callno']==3){$callno="Third Call";}  
  echo '<td>'.ConvertSQLDate($result_tb["due_date1"]).'</td>';
  echo '<td>'.$actal1.'</td>';
  echo '<td>'.$due2.'</td>';
  echo '<td>'.$actal2.'</td>';
