...
//       echo '<center><h2>Leads</h2></center>';
    ...
    echo "<td><input type='text' name='custname' id='custid' value='$custname' readonly onkeyup='caps1()'  style='width:190px'></td>";
    
 //       echo "<tr><td>House No:</td><td><input type='text' name='Houseno' id='Houseno' onkeyup='' style='width:99%'></td></tr>";    
        echo "<tr><td>Org Name:</td><td><input type='text' name='HouseName' id='HouseName' value='$housename' onkeyup='' style='width:99%'></td></tr>";
...
echo '<tr><td>Phone number</td>';
  ...
  {     
  if ($myrow1['categoryid']==$productservicesid)  
    { 
    echo '<option selected value="';
    echo $productservicesid . '">'.$myrow1['categorydescription'];
    } else {
        echo '<option value="';
...
//  $myrow6 = DB_fetch_array($result6);
 ...
 //echo   $teamid;
  ...
  while ($myrow = DB_fetch_array($result)) {
     $c=0;
    if ($myrow['categoryid']==$myrow4['sourcetypeid']) 
    {
    echo '<option selected value="';
