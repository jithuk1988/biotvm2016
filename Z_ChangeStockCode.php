...
/* $Id: Z_ChangeStockCode.php 4570 2011-05-16 07:41:47Z daintree $*/
...
/*Now check that the new code doesn't already exist */
	...
	if ($InputError ==0){ // no input errors
        ...
        echo '<br />' . _('Changing the concept proposal records');
        $sql = "UPDATE bio_conceptproposaldetails SET stockid='" . $_POST['NewStockID'] . "' WHERE stockid='" . $_POST['OldStockID'] . "'";
        $ErrMsg = _('The SQL to update concept proposal records failed');
        $result = DB_query($sql,$db,$ErrMsg,$DbgMsg,true);
        echo ' ... ' . _('completed');
        
        
        ////---------CP SUBSIDY---------//////  
        echo '<br />' . _('Changing the concept proposal subsidy records');
        $sql = "UPDATE bio_cpsubsidy SET stockid='" . $_POST['NewStockID'] . "' WHERE stockid='" . $_POST['OldStockID'] . "'";
        $ErrMsg = _('The SQL to update concept proposal subsidy records failed');
        $result = DB_query($sql,$db,$ErrMsg,$DbgMsg,true);
        echo ' ... ' . _('completed');
        
        
        ////---------OLD ORDERS---------//////  
        echo '<br />' . _('Changing the Old Orders records');
        $sql = "UPDATE bio_oldorders SET plantid='" . $_POST['NewStockID'] . "' WHERE plantid='" . $_POST['OldStockID'] . "'";
        $ErrMsg = _('The SQL to update Old Orders records failed');
        $result = DB_query($sql,$db,$ErrMsg,$DbgMsg,true);
        echo ' ... ' . _('completed');
        
        
          ////---------PROPOSALS---------//////  
        echo '<br />' . _('Changing the Proposal records');
        $sql = "UPDATE bio_proposaldetails SET stockid='" . $_POST['NewStockID'] . "' WHERE stockid='" . $_POST['OldStockID'] . "'";
        $ErrMsg = _('The SQL to update Old Orders records failed');
        $result = DB_query($sql,$db,$ErrMsg,$DbgMsg,true);
        echo ' ... ' . _('completed'); 
        ...
        ////---------PROPOSAL SUBSIDY---------//////  
        echo '<br />' . _('Changing the proposal subsidy records');
        $sql = "UPDATE bio_propsubsidy SET stockid='" . $_POST['NewStockID'] . "' WHERE stockid='" . $_POST['OldStockID'] . "'";
        $ErrMsg = _('The SQL to update proposal subsidy records failed');
        $result = DB_query($sql,$db,$ErrMsg,$DbgMsg,true);
        echo ' ... ' . _('completed');
        
        
         ////---------TEMP PROPOSAL ITEMS---------//////  
        echo '<br />' . _('Changing the temp proposal records');
        $sql = "UPDATE bio_temppropitems SET stockid='" . $_POST['NewStockID'] . "' WHERE stockid='" . $_POST['OldStockID'] . "'";
        $ErrMsg = _('The SQL to update temp proposal records failed');
        $result = DB_query($sql,$db,$ErrMsg,$DbgMsg,true);
        echo ' ... ' . _('completed');
