	...
	if ($SelectedCategory AND $InputError !=1) {
        ...
        $sql4="UPDATE bio_maincat_subcat        
               SET maincatid = " . $_POST['MainCategoryID'] . ",
                subcatid='" . $_POST['CategoryID'] . "'
                WHERE subcatid= '".$SelectedCategory."';
               ";
...
if (! isset($_GET['delete'])) {
	...
	if (isset($SelectedCategory)) {
		...
		if (!isset($_POST['UpdateTypes'])) {
            ...
            $sql5="SELECT bio_maincat_subcat.maincatid
                   FROM bio_maincat_subcat
                   WHERE bio_maincat_subcat.subcatid ='" . $SelectedCategory . "'";
            $result5=DB_query($sql5,$db);
            $myrow5=DB_fetch_array($result5);
            $_POST['MainCategoryID']=$myrow5[0];
		}
	...
	echo '<tr><td>' . _('Category Description') . ':</td>
     ...
     echo '<tr><td>' . _('Main Category') . ':</td><td><select name="MainCategoryID">';
