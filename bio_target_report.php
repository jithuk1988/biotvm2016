...
//   $BDE_count=$myrow8['Count'];             
   ...
   echo$sql8="select empname from bio_emp where offid=".$_POST['Office']." AND designationid=9";
   $result8=DB_query($sql8,$db);                                                              }
 ...
 print_r($payment_arr);        
  ...
  $acvmnt_per_leads=$achvmnt_leads/$target_leads*100;
      ...
      $target_fs+=$fscharge_arr[$i];
      $achvmnt_fs+=$fscharge_achmt_arr[$i];     
       
       }
      $acvmnt_per_fs=$achvmnt_fs/$target_fs*100;            
      ...
      $achvmnt_payment+=$payment_achmt_arr[$i]; 
       ...
       $total_target=$target_fs+$target_SOR+$target_payment; 
       $total_achmt=$achvmnt_fs+$achvmnt_SOR+$achvmnt_payment;
       $totalcollection=$total_achmt/$total_target*100;     
