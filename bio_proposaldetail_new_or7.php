...
echo"<td><input type='text' name='ExpectedDate' placeholder='DD/MM/YYYY'  id='date' class=date alt='".$_SESSION['DefaultDateFormat']. "' onkeypress='return noenter()' style='width:135px'></td></tr>";
echo"<tr></tr>";
...
echo"</div>";
echo"</td></tr></table>"; 
echo '<center><input type="button" name="newfs" id="newfs" value="Create New" onClick="new()"></center>';       
