...
if(isset($_POST['search']))
{
  ...
  $SQL="select mrpdemands.stockid,mrpdemands.quantity,stockmaster.description FROM  mrpdemands,stockmaster WHERE mrpdemands.duedate='".$date1."' AND mrpdemands.location='".$location."' AND mrpdemands.workcenter='".$workcenter."' AND quantity>0 
