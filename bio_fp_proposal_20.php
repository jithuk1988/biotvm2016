...
echo$sql="SELECT bio_cust.custname,
               bio_leadtask.leadid,
...
//    $result=DB_query($sql,$db);
 ...
 $sql="SELECT bio_cust.custname AS custname,               
          ...
          FROM 
               ...
               bio_leadtask,
		 bio_cust
	LEFT JOIN bio_state ON bio_cust.state=bio_state.stateid
	LEFT JOIN bio_district ON bio_cust.district=bio_district.did
         WHERE bio_cust.cust_id=bio_leads.cust_id  
           AND bio_leads.enqtypeid=2
...
echo$sql5="SELECT bio_fsproposal.leadid,
