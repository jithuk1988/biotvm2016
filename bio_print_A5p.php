...
if($modeid==1)
{
$string="Received from Ms. ".$myrow1['custname'].", ".$myrow1['area1'].", the Sum of Rs. ".$myrow2['amount']."/- towards ".$myrow4['heads']." by ".$myrow3['modes'].".";    
$pdf->addTextWrap($Left_Margin,$YPos-120,800,$FontSize+2,$string,'',0);
$pdf->addTextWrap($Left_Margin,$YPos-530,800,$FontSize+2,$string,'',0);
}    
elseif($modeid==2 || $modeid==3)
{
$string="Received from Mr / Mrs. ".$myrow1['custname'].", ".$myrow1['area1'].", the Sum of Rs. ".$myrow2['amount']."/- towards ".$myrow4['heads'];    
