...
$sql3=$_SESSION['qry'];
    ...
    $objPHPExcel->getActiveSheet()->SetCellValue('B1', 'C/O');
    $objPHPExcel->getActiveSheet()->SetCellValue('C1', 'Address');
     $objPHPExcel->getActiveSheet()->SetCellValue('D1', 'LSG');
    $objPHPExcel->getActiveSheet()->SetCellValue('E1', 'BLOCK');
...
while($row = DB_fetch_array($result)){
 ...
 if($row['LSG_type']==3)
    ...
    $objPHPExcel->getActiveSheet()->SetCellValue('A'.$rowCount, $row['name']);
        $objPHPExcel->getActiveSheet()->SetCellValue('B'.$rowCount, $row['debtorno']);
 
    $objPHPExcel->getActiveSheet()->SetCellValue('C'.$rowCount, str_replace('</br>',',',$row['address']));
    $objPHPExcel->getActiveSheet()->SetCellValue('D'.$rowCount, $LSG_name);
    $objPHPExcel->getActiveSheet()->SetCellValue('E'.$rowCount,$block);
    ...
    $objPHPExcel->getActiveSheet()->SetCellValue('I'.$rowCount, $row['capacity']);
    $objPHPExcel->getActiveSheet()->SetCellValue('J'.$rowCount, $row['model']);

    $objPHPExcel->getActiveSheet()->SetCellValue('K'.$rowCount, $row['plantstatus']);
