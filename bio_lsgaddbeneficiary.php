...
// $result=DB_query($sql_cust1,$db); 
 ...
 /*$sql_lead1 ="UPDATE bio_leads SET custid=".$cust_id.",            
  ...
  $sql_cust= "INSERT INTO bio_cust(custname,houseno,housename,area1,area2,pin,LSG_Ward,taluk,village,custphone,custmob,custmail,nationality,state,district,LSG_type,LSG_name,block_name)             
                 VALUES ('".$cust_name."',
                        '".$House_no."',
                        '".$House_name."',
                        '".$lsg_area1."',
 ...
 $sql_lead="INSERT INTO bio_leads(cust_id,leaddate,id_type,id_no,schemeid,remarks,created_by,parent_leadid,leadstatus,enqtypeid)
                                    VALUES('".$cust_id."', 
                                            '".$date."',                                     
                                            '".$idtype."',
                                            '". $idno."',                                               
