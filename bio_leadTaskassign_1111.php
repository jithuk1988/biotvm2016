...
if (isset($_POST['submit'])) {
    ...
    if($status_count>0){
        $sql_st1="UPDATE bio_leadtask SET viewstatus=0
                        WHERE leadid=".$leadarray[$i];
        $result_st1=DB_query($sql_st1,$db);
        
        $sql_st2="UPDATE bio_leadtask SET taskcompletedstatus=2 
                WHERE leadid=".$leadarray[$i]."
                AND taskcompletedstatus=0";
        $result_st2=DB_query($sql_st2,$db);
