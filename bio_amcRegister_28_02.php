...
{    
  ...
  if(isset($_GET['edit']))
{ 
      $sql_getdebt="SELECT debtorno,plant,start_date,end_date,amc_type,cust_type FROM bio_amc WHERE amc_no='".$_GET['edit']."'";
...
{ 
    ...
    $sql_update="update bio_amc set cust_type='".$_POST['type']."',plant='".$_POST['plantname']."',start_date='".FormatDateForSQL($_POST['startdate'])."',end_date='".FormatDateForSQL($_POST['enddate'])."',amc_type='".$_POST['amctype']."'     WHERE amc_no='".$_POST['amcid']."'";
...
if (isset($_POST['submit'])){
    $date=date('Y-m-d');
     $sql_insert="INSERT INTO bio_amc (amc_date,debtorno,cust_name,cust_type,plant,start_date,end_date,amc_type)
    VALUES ('".$date."','".$_POST['debtorno']."','".$_POST['custname']."','".$_POST['type']."','".$_POST['plantname']."','".FormatDateForSQL($_POST['startdate'])."','".FormatDateForSQL($_POST['enddate'])."','".$_POST['amctype']."')";
     $result_insert=DB_query($sql_insert,$db);
    ...
    // $sql1.=" ORDER BY bio_incidents.ticketno DESC";
     ...
     while($row1=DB_fetch_array($result1) ){ 
         ...
         echo"<tr style='background:#A8A4DB'>
                                    ...
                                    <td><a href='#' id='$row1[amc_no]' onclick='delet(this.id)'>Delete</a></td>";  
...
//      $('#dinhide').show(); 
  ...
  //alert(str);
xmlhttp.open("GET","bio_amc_plant.php?maincatid="+str,true);
xmlhttp.send(); 
}
