...
if(str2==28){
    ...
    if(str5==27){
      ...
      if(str5==4){
      controlWindow=window.open("bio_detailedprojectproposal.php?lead="+str1 +"&taskid=" + str5 + "&tid=" + str6,"so_cp","toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=1300,height=460");    
      }
      if(str5==29){
      controlWindow=window.open("bio_multiplePayment.php?lead=" + str1 +"&task=" + str5 + "&tid=" + str6 +"&leadtype="+leadtype,"Payment","toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=1200,height=400");      
      }
...
if($_GET['lead']!=''){
 ...
 $result=DB_query($sql,$db);//                AND bio_leadteams.teamid=bio_leads.teamid
...
AND bio_leads.leadstatus!=20"; 
 ...
 //echo $_POST['task'];AND bio_leadtask.teamid=$teamid
