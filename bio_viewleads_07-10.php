...
/*  $sql="SELECT bio_cust.cust_id AS custid,  
 ...
 $sql="SELECT leadid,custname,biostatus,houseno,housename,place,custphone,custmob,contactperson,enqtype,outputtype,leaddate,remarks,amount,grade,teamname,sourcename,district,office,created_by,emailstatus from viewleads where leadid !=0 ";                          
...
//    }
    ...
    $sql.=" AND viewleads.sourceid='".$_POST['leadsrc']."'";
    }
    ...
    $sourcetypefrom=FormatDateForSQL($_POST['datef']);   
    $sourcetypeto=FormatDateForSQL($_POST['datet']);
    $sql.=" AND viewleads.leaddate BETWEEN '".$sourcetypefrom."' AND '".$sourcetypeto."'";
    /*$datef=$_POST['datef'];
    $datet=$_POST['datet'];
    ...
    if (isset($_POST['byplace'])) {
    if ($_POST['byplace']!='') 
    $sql.= " AND viewleads.district LIKE '%".$_POST['byplace']."%'"; 
    }
    ...
    if ($_POST['LeadStatus']!=''){
          ...
          if($leadstatus==0)
          {
     $sql.=" AND viewleads.leadstatus IN (0,2,7,45,46,47,15)"; 
                  
          }
          
          if($leadstatus==26)
          {
     $sql.=" AND viewleads.leadstatus IN (7,26,47)";  
          ...
          if($leadstatus==10)
          {
     $sql.=" AND viewleads.leadstatus IN (3)";  
          ...
          if($leadstatus==4)
          {
     $sql.=" AND viewleads.leadstatus IN (10,11,30,4,27,2,1)";  
          ...
          if($leadstatus==5)
          {
     $sql.=" AND viewleads.leadstatus IN (13,5,28,31)";  
          ...
          if($leadstatus==6)
          {
     $sql.=" AND viewleads.leadstatus IN (6,25,29,34,35,36,37,38,39,40,42,43)";  
  ...
  if (isset($_POST['Amount']))  {        
   ...
   $sql.="AND viewleads.amount>0 AND head_id=8";                
      }  
...
//  $sql.="AND (bio_advance.amount=0 AND head_id=8) OR (bio_advance.amount>=0 AND head_id!=8)";
    ...
    $sql.= " AND (viewleads.custname LIKE '%".$_POST['byname']."%'
    OR viewleads.custname SOUNDS LIKE '%".$_POST['byname']."%'
    OR viewleads.custname LIKE '%".$name2."%')";   
    }                                                                    
...
/*     if (isset($_POST['off']))    {
     ...
     if (($_POST['off']!='')&&($_POST['off']!='0') && (($_POST['team']=='')||($_POST['team']=='0')))
    {
               ...
               $sql.=" AND viewleads.teamid in (Select teamid from bio_leadteams where office_id=".$_POST['off'].") ";    

        
    }
    else      if (($_POST['off']!='')&&($_POST['off']!='0') && ($_POST['team']!='')||($_POST['team']!='0'))
                     {
                                     $sql.=" AND viewleads.teamid in ($team_array)"; 
    ...
    $sql.=" AND viewleads.teamid='".$_POST['team']."'";    
    }
    ...
    $sql.=" AND viewleads.enqtypeid='".$_POST['enquiry']."'";//
    $enquiry=1;
    } 
    
    if (isset($_POST['grade_filter'])) {   
    if ($_POST['grade_filter']!="") {        
    $sql.=" AND viewleads.grade='".$_POST['grade_filter']."'";      
    }
    }
  ...
  { 
    ...
    if($enquiry==0){
       $sql.="AND viewleads.enqtypeid=2 AND viewleads.leadstatus!=20 ";
       $enquiry=1; 
    }
    }    
}
...
//             
//}
  $sql.=" And viewleads.leadstatus not in(20,21,22,23,24) GROUP BY viewleads.leadid ORDER by viewleads.leadid desc";
  // echo $sql;       
