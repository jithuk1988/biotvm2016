...
echo"<fieldset style='width:875px;height:380px'>";
...
echo"<td><input style='width:96%' type='text' placeholder='DD/MM/YYYY' name='ConductedDate' id='conducteddate' class=date alt='".$_SESSION['DefaultDateFormat']. "'></td></tr>";
...
echo"<input type='hidden' name='FSID' id='leadid' value='$fs_ID'>";
echo'<input type="hidden" name="custid" value='.$cust_id.'>';
echo"<td><input type='hidden' name='check' id='check' value='0' style='width:150px'></td></tr>";
?>
