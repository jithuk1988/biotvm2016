...
if (isset($_POST['submit'])) {
 ...
 $add=$_POST['Add'];
  ...
  var stock='<?php echo $stockid; ?>';   //alert(id);
  window.opener.location='bio_proposal.php?editlead='+<?php echo $lead;?>+'&prop_id='+<?php echo $flag;?>+'&subsidy=1'+'&stockid1='+stock;
...
//        $sub_amount=$_GET['amount'];
  ...
  var flag='<?php echo $_SESSION['prop']; ?>';
    window.opener.location='bio_proposal.php?editlead='+<?php echo $lead;?>+'&prop_id='+<?php echo $flag;?>+'&subsidy=1'+'&stockid='+stock;
...
echo '<table width=80%>';
    ...
    echo'<input type="hidden" name="prop" id="prop" value="' . $_SESSION['prop'] . '" style="width:200px">';
