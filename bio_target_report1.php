...
while($myrow=DB_fetch_array($resultl))
  {
       //$employee_arr[]=$myrow['empid'];  
//         $team_arr[]=$myrow['teamid'];     
$office1=$myrow_off['office'];         
if($myrow['task']=='0'){
  $leads+=$myrow['target'];
...
//$feasibility_per=$fs_achmnt1/$feasibility*100;
 ...
 if($myrow['task']==28){
  ...
  //$fscharge_achmt_arr[]=$myrow_ch['Count'];  
 ...
 // $SOcollect_arr[]=$myrow['target'];      
  ...
  //$SOcollect_achmt_arr[]=$myrow_SO['Count'];
 ...
 if($myrow['task']==26){
  ...
  //$payment_achmt_arr[]=$myrow_pay['Count'];
...
//         
//         
//          $total_target1=$target_fs+$target_SOR+$target_payment;
//           
//         $total_achmt1=$achvmnt_fs+$achvmnt_SOR+$achvmnt_payment;
//       
//       
//       
//       
//       if ($totalcollection1!=0) {
// 
// $total_achmt=round($total_achmt/$total_collection1*100,2);    
// }
//         $totalcollection1=$total_achmt1/$total_target1*100;     
//         
       // echo"<td align=center><b>".$totalcollection.'%'."</b></td>"; 
...
//   $BDE_count=$myrow8['Count'];             
  ...
  echo $sql_task="select count(*) as Count from bio_leadtask where teamid IN(select teamid from bio_leadteams)";
...
//        <td align=center rowspan=2><b>' . _('Task description') . '</b></td>';
//  
// echo '<td align=center colspan=2><b>' . _('BDE-'.$i) . '</b></td>';      
//  
// echo ' </tr>';
// echo'<tr>';
