...
elseif(isset($_POST['incidentflag']) AND $_POST['incidentflag']!=""){
   ...
   ?>
     <script>
     controlWindow=window.open("bio_oldorders.php?Debtorid","oldorder","toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=1500,height=600");
     window.close();
     </script>
     <?php
   ...
   echo'</tr>'; 
    ...
    echo'<div style="align:left" id=block>';
      ...
      echo'</td></tr>';     
                  ...
                  <td><input tabindex=9 type="Text" name="village" id="village" style=width:190px maxlength=100 value="'.$_POST['village'].'"></td></tr>';        
