...
echo'<td>Type :</td>';
echo'<td><select name="cust_type" id="cust_type">';
if($_POST['cust_type']==1){
    echo'   <option selected value=1>Domestic</option>
            <option value=2>Institutional</option>
            <option value=3>Domestic(LSGD)</option>';
}
  elseif($_POST['cust_type']==2){
    echo'   <option  value=1>Domestic</option>
            <option selected value=2>Institutional</option>
            <option value=3>Domestic(LSGD)</option>';
}
elseif($_POST['cust_type']==3){
    echo'   <option  value=1>Domestic</option>
            <option  value=2>Institutional</option>
            <option selected value=3>Domestic(LSGD)</option>';
}
else{
    echo'   <option selected value=1>Domestic</option>
            <option  value=2>Institutional</option>
...
$sql="SELECT salesorderdetails.orderno,
     ...
     elseif($_POST['cust_type']==3)
     {
         $sql.=" AND debtorsmaster.debtorno LIKE '".L."%'"; 
     }
     else
     {
        $sql.=" AND debtorsmaster.debtorno LIKE '%".D."%' AND debtorsmaster.debtorno NOT LIKE '".DL."%' "; 
     }    
