...
if($app_status==1){
$sql="UPDATE bio_approval SET taskcompletedstatus =1 
...
elseif(($app_status==0) AND (($task_ID==9 || $task_ID==10))){
...
elseif(($app_status==0) AND ($task_ID==11)){
...
elseif(($app_status==0) AND ($task_ID==16)){
...
echo"<fieldset style='width:400px;height:150px'>"; 
