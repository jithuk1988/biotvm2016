...
// $result=DB_query($sql_cust1,$db); 
 ...
 /*$sql_lead1 ="UPDATE bio_leads SET custid=".$cust_id.",            
                                         leaddate='".date("Y-m-d")."',
                                         schemeid='".$_POST['schm']."',  
 ...
 echo  $sql_cust= "INSERT INTO bio_cust(custname,houseno,housename,area1,area2,pin,LSG_Ward,taluk,village,custphone,custmob,custmail,nationality,state,district,LSG_type,LSG_name,block_name)             
                 VALUES ('".$cust_name."',
                        '".$House_no."',
                        '".$House_name."',
                        '".$lsg_area1."',
 ...
 echo  $sql_lead="INSERT INTO bio_leads(cust_id,leaddate,id_type,id_no,outputtypeid,remarks,created_by,parent_leadid,leadstatus,enqtypeid)
                                    VALUES('".$cust_id."', 
                                            '".$date."',                                     
                                            '".$idtype."',
                                            '". $idno."',                                               
...
WHERE bio_leads.leadid=".$parent_leadid;   
 ...
 $advance_amount    =$myrow['amount'];
  ...
  unset ($main_share);
  unset ($block_share);
  unset ($district_share); 
  unset ($advance_amount); 
  unset ($mode_payment);
  unset ($schemeid);
  unset ($remark);
  }
 ...
 echo "<td><input type='text' name='custname' id='custid' value='$cust_name'  tabindex=1 onkeyup='caps1()' style='width:200px'></td>";

 echo "<tr><td>House No:</td><td><input type='text' name='Houseno' id='Houseno' value='$House_no'  tabindex=2 onkeyup='' style='width:99%'></td></tr>";    
 echo "<tr><td>House / Organizational Name</td><td><input type='text' name='HouseName' id='HouseName' value='$House_name'  tabindex=3 onkeyup='' style='width:99%'></td></tr>";
 echo "<tr><td>Residential Area:</td><td><input type='text' name='Area1' id='Area1' value='$lsg_area1'  tabindex=4 onkeyup='' style='width:99%'></td></tr>";
 echo "<tr><td>Post Office:</td><td><input type='text' name='Area2' id='Area2' value= '$lsg_area2' tabindex=5 onkeyup='' style='width:99%'></td></tr>";
 echo" <tr><td>Pin:</td><td><input type='text' name='Pin' id='Pin' value='$lsg_Pin'  tabindex=6 onkeyup='' style='width:99%'></td></tr>";    
...
/*    echo"<tr id='showtaluk'></tr>";     
 ...
 echo '<select name="village" id="Village"  style="width:200px"  onchange="showvillage(this.value)">';
  ...
  echo '</tr>';  
    ...
    echo "<td><table><td><input type='text' name='code' id='code' value='$code' style='width:50px' tabindex=8></td><td><input type='text' name='phone' tabindex=9 id='phone' value='$phn' style='width:100%' onchange=checkLandline()></td></table></td></tr>";
    
    echo '<tr><td>Mobile Number</td>';
    echo "<td><input type=text name=mobile id=mobile value='$lsg_mobile'  style='width:98%' tabindex=10 ></td><td id=mob></td></tr>"; 
    echo '<tr><td>Email id</td>';
    echo "<td><input type=text name='email' id='email' value='$lsg_email'  style='width:98%' tabindex=11 onchange='address()'></td></tr>";    
    
    
        
     echo '<tr><td>Identity Type</td>';
     echo'<td><select name="identity" id="identity" value="$idtype" style="width:200px" tabindex=12>';
...
echo'</select></td></tr>';
  ...
  echo "<td><input type=text name=advanceamt id='advance' value='$advance_amount' style='width:190px' tabindex=14 onblur='amntmode(this.value)'></td></tr>";
...
while($myrow1=DB_fetch_array($result1))
{
 ...
 $sql_out="SELECT * FROM bio_outputtypes";
  ...
  //echo "<td><textarea name='remarks' id='remarks' value='$remark' rows=4 cols=26 tabindex=22 style=resize:none;></textarea></td>"; 
  echo "<td><textarea name='remarks' id='remarks' value='$remark' rows=4 cols=26 tabindex=22 style=resize:none;>$remark</textarea></td>";
  echo '</tr>';
...
xmlhttp.open("GET","bio_CustlsgSelection_lsg.php?country=" + str,true);
xmlhttp.send();
}  
