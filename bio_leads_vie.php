...
<table >
<tr>
<td>Customer Name</td><td><input type="text" id="cname" name="cname" ></td>
<?php
echo ' <td>Date From</td><td><input type="text" id="fdate" name="fdate" class="date"  alt="'.$_SESSION['DefaultDateFormat'].'"></td>
<td>Date To</td><td><input type="text" id="tdate" name="tdate" class="date" alt="'.$_SESSION['DefaultDateFormat'].'" ></td> ';                                                                                                                     
?>
<td>District</td><td><input type="text" name="ldist" id="ldist"></td>
...
<?php
     $sql= "SELECT bio_leads.leadid,bio_leads.cust_id,leaddate,remarks,bio_cust.custname,bio_cust.area1,bio_district.district,concat(bio_cust.custphone,'-</br>',bio_cust.custmob) as 'cont'
      from bio_cust 
   ...
   bio_leads.leadstatus='20'  ";
                               
if(isset($_POST['submit']))
 {
   if( $_POST['cname'] ){$sql.=" AND bio_cust.custname  LIKE '%".$_POST['cname']."%'"; }
   //if($_POST['fdate']){$sql.=" AND bio_cust.custname  LIKE '%".$_POST['cname']."%'";}
