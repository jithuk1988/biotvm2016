...
echo '<center><font style="color: #333;
    ...
    font-size:16px;
    font-family:Georgia;
    text-shadow: 1px 1px 1px #666;">Price List</font></center>';
...
echo"<td>".$slno."</td><td>".$myrow['stockid']."</td><td>".$myrow['description']."</td><td>".ConvertSQLDate($myrow['startdate'])."</td><td>".ConvertSQLDate($myrow['enddate'])."</td><td  align='right'><b>".number_format($myrow['price'],2)."</b></td>";       
      $slno++;
                }
// $total=0         
