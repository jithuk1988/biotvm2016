...
if(isset($_POST['CategoryID']))     {
    ...
    $sql7="SELECT maincatid
           FROM bio_maincat_subcat
           WHERE subcatid='".$_POST['CategoryID']."'";
...
echo '</select></td></tr>';
 ...
 echo '<tr><td>' . _('Sub Category') . ':</td><td id="subcat"><select name="CategoryID" onChange="ReloadForm(ItemForm.UpdateCategories)">';
