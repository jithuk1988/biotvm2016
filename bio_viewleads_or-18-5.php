...
echo'<td class="datefrom"><input type="text"  id="datefrm" class=date alt='.$_SESSION['DefaultDateFormat']. ' name="datef" value="'.$_POST['datef'].'" onChange="return isDate(this, this.value, '."'".$_SESSION['DefaultDateFormat']."'".')'.'"'.' style="width:120px">';    


echo'<td class="dateto"><input type="text"  id="dateto" class=date alt='.$_SESSION['DefaultDateFormat']. ' name="datet" value="'.$_POST['datet'].'" onChange="return isDate(this, this.value, '."'".$_SESSION['DefaultDateFormat']."'".')'.'"'.' style="width:120px">';    
echo"</td>";  
 ...
 echo '<td  class="bydistrict"><input type="text" name="byplace" id="byplace" value="'.$_POST['byplace'].'" style="width:120px"></td>';
   ...
   echo '<option value=0></option>'; 
   $sql1="select * from bio_leadteams WHERE teamid IN ($team_array)";
...
echo'</select></td></tr>';
   ...
   echo '</tr>';
      ...
      echo"   <th width='9%'>" . _('Status') . "</th> 
              <th width='24%'>" . _('Remarks') . "</th>
              <th width='10%'>" . _('Next Task') . "</th>  
...
SELECT DISTINCT  bio_leadtask.leadid AS leadid, bio_cust.cust_id AS custid, bio_cust.custname AS custname, 
    ...
    bio_office.id AS officeid, bio_office.office AS office, bio_leads.remarks AS remarks, bio_leads.created_by 
FROM bio_leads
