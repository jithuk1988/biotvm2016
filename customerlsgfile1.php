...
if($_GET['block']){ 
        ...
        $district=$row['district'];
          ...
          if($cid==1 && $sid==14)  
          {
              ...
              if($district==8){$distname='Kozhikode';} 
                    ...
                    echo '<td><select name="lsgName" id="lsgName" style="width:190px" tabindex=11 onchange="showlocation(this.value)">';
    ...
    elseif($_GET['block']==3)          //block Panchayath
    {
      ...
      echo '<tr id="showgramapanchayath"><td width=200px>' . _('Panchayat Name') . ':</td>';         
...
if($_GET['grama']){                  //grama panchayath 
      ...
      echo '<tr><td width=200px>' . _('Panchayat Name') . ':</td>';         
         ...
         echo '<td><select name="gramaPanchayath" id="gramaPanchayath" style="width:190px" tabindex=11 onchange="showlocation(this.value)">';
         $f=0;
         while($myrow1=DB_fetch_array($result))
         {
         if ($myrow1['id']==$_POST['gramaPanchayath'])
