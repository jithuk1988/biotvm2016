...
//echo "<head><title='Lead List'></head>";
...
$sql_emp1="SELECT * FROM bio_emp WHERE empid=".$empid;
 ...
 $employee_arr=array();   
  ...
  echo"<center><div id='editleads' style='background-color: #D5D5DA;'>";
  echo "<table style='width:80%;;align:center'><tr><td>";
 ...
 /* echo "<fieldset style='width:20%;height:440px'>";     
  ...
  echo "<td>"; 
  echo "<div id='printandshow' style='margin:auto;align:center'>";
  echo "<fieldset style='width:90%;height:460px;align:center'>";     
  echo "<legend><h3>Lead List</h3>";     
  echo "</legend>";  
  echo "<table style='border:1px solid #ECF1EF; width:100%;align:center'>";
  ...
  { 
     echo '<tr>
             ...
             <td class="status" style="display:none">Lead Source</td>  
           </tr>';
...
echo"</td>";  
 ...
 echo '<td  class="bydistrict"><input type="text" name="byplace" id="byplace" value="'.$_POST['byplace'].'" style="width:120px"></td>';
   ...
   echo '</select></td>';      
      ...
      echo '<td id="byoffice"><select name="off" id="off"  style="width:120px">';
   echo '<option value=0></option>'; 
...
echo'</select></td>';
   ...
   echo '</tr>';  */
    ...
    echo '<td class="leadsource" style="display:none"><select name="leadsrc" id="leadsrc" style="width:120px">';
   echo '<option value=0></option>';
   ...
   echo '</tr>';
      ...
      echo "<thead>
         ...
         <th width='9%'>" . _('Customer Type') . "</th>   
         <th width='12%'>" . _('Contact No') . "</th>
         <th width='10%'>" . _('Lead Date') . "</th>  
...
echo "<td width=4%'>$slno</td>";
            //  convertsqldatefordis(d)
            $dt=convertSQLDate($myrow['leaddate']) ;
        echo "<td width='14%'>$custname</td>";  
        echo"<td width='9%'>$myrow[enqtype]</td>";            
        echo"<td width='12%'>$custmob</td>";          
          echo"<td width='10%'>".$dt."</td>";   
        echo"<td width='14%'>".$myrow['district']."</td>";
    if(!isset($_GET['team']))
  {      
        echo"<td width='10%' class='team'>$teamname</td>";  }
        echo"<td width='15%'>".$myrow['biostatus']."</td>";
if($_SESSION['UserID']=='bdm_national' || $_SESSION['UserID']=='bde_national1' ||$_SESSION['UserID']=='bdm_international' ||$_SESSION['UserID']=='bde_international1') 
{
