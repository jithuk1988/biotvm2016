...
}     else
{
 echo '<input  style="width:170px" type="text" name="caldate" id="caldate" class=date alt="'.$_SESSION['DefaultDateFormat']. '" value='.date("d/m/Y").'>'; }?>
  ...
  <td colspan="17"><label><center>
    <span class="style5">Report of leads processed on <?php echo $createdate; ?></span>
  </center></label></td>
 </tr>
    <tr>
    ...
    <tr>
      ...
      <td bgcolor="#CC99CC"><div align="center"><strong><?php echo $c[3][0];?></strong></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $c[3][1];?></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $c[3][2];?></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $c[3][0]+$c[3][1]+$c[3][2];?></div></td>
      
            <td bgcolor="#CC99CC"><div align="center"><strong><?php echo $d[3][0];?></strong></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $d[3][1];?></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $d[3][2];?></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $d[3][0]+$d[3][1]+$d[3][2];?></div></td>
      
         <td bgcolor="#CC99CC"><div align="center"><strong><?php echo $f[3][0];?></strong></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $f[3][1];?></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $f[3][2];?></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $f[3][0]+$f[3][1]+$f[3][2];?></div></td>
      
            <td bgcolor="#CC99CC"><div align="center"><strong><?php echo $e[3][0];?></strong></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $e[3][1];?></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $e[3][2];?></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $e[3][0]+$e[3][1]+$e[3][2];?></div></td>
    </tr>
    <tr>
      <th ><strong>Distributor</strong></th>
      <td><div align="center"><strong><?php echo $c[4][0];?></strong></div></td>
      <td><div align="center"><?php echo $c[4][1];?></div></td>
      <td><div align="center"><?php echo $c[4][2];?></div></td>
      <td><div align="center"><?php echo $c[4][0]+$c[4][1]+$c[4][2];?></div></td>
      
      <td><div align="center"><strong><?php echo $d[4][0];?></strong></div></td>
      <td><div align="center"><?php echo $d[4][1];?></div></td>
      <td><div align="center"><?php echo $d[4][2];?></div></td>
      <td><div align="center"><?php echo $d[4][0]+$d[4][1]+$d[4][2];?></div></td>
      
      <td><div align="center"><strong><?php echo $f[4][0];?></strong></div></td>
      <td><div align="center"><?php echo $f[4][1];?></div></td>
      <td><div align="center"><?php echo $f[4][2];?></div></td>
      <td><div align="center"><?php echo $f[4][0]+$f[4][1]+$f[4][2];?></div></td>
      
      <td><div align="center"><strong><?php echo $e[4][0];?></strong></div></td>
      <td><div align="center"><?php echo $e[4][1];?></div></td>
      <td><div align="center"><?php echo $e[4][2];?></div></td>
      <td><div align="center"><?php echo $e[4][0]+$e[4][1]+$e[4][2];?></div></td>
    </tr>
    <tr>
      <th ><strong>JV</strong></th>
      <td bgcolor="#CC99CC"><div align="center"><strong><?php echo $c[5][0];?></strong></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $c[5][1];?></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $c[5][2];?></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $c[5][0]+$c[5][1]+$c[5][2];?></div></td>
      
            <td bgcolor="#CC99CC"><div align="center"><strong><?php echo $d[5][0];?></strong></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $d[5][1];?></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $d[5][2];?></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $d[5][0]+$d[5][1]+$d[5][2];?></div></td>
      
         <td bgcolor="#CC99CC"><div align="center"><strong><?php echo $f[5][0];?></strong></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $f[5][1];?></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $f[5][2];?></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $f[5][0]+$f[5][1]+$f[5][2];?></div></td>
      
            <td bgcolor="#CC99CC"><div align="center"><strong><?php echo $e[5][0];?></strong></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $e[5][1];?></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $e[5][2];?></div></td>
      <td bgcolor="#CC99CC"><div align="center"><?php echo $e[5][0]+$e[5][1]+$e[5][2];?></div></td>
    </tr>
    <tr>
      <th ><strong>Others</strong></th>
      <<td><div align="center"><strong><?php echo $c[6][0];?></strong></div></td>
      <td><div align="center"><?php echo $c[6][1];?></div></td>
      <td><div align="center"><?php echo $c[6][2];?></div></td>
      <td><div align="center"><?php echo $c[6][0]+$c[6][1]+$c[6][2];?></div></td>
      
      <td><div align="center"><strong><?php echo $d[6][0];?></strong></div></td>
      <td><div align="center"><?php echo $d[6][1];?></div></td>
      <td><div align="center"><?php echo $d[6][2];?></div></td>
      <td><div align="center"><?php echo $d[6][0]+$d[6][1]+$d[6][2];?></div></td>
      
      <td><div align="center"><strong><?php echo $f[6][0];?></strong></div></td>
      <td><div align="center"><?php echo $f[6][1];?></div></td>
      <td><div align="center"><?php echo $f[6][2];?></div></td>
      <td><div align="center"><?php echo $f[6][0]+$f[6][1]+$f[6][2];?></div></td>
      
      <td><div align="center"><strong><?php echo $e[6][0];?></strong></div></td>
      <td><div align="center"><?php echo $e[6][1];?></div></td>
      <td><div align="center"><?php echo $e[6][2];?></div></td>
      <td><div align="center"><?php echo $e[6][0]+$e[6][1]+$e[6][2];?></div></td>
    </tr>
  </table>
