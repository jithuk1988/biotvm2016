...
include('includes/sidemenu.php');
  ...
  echo '<center><font style="color: #333;
                           ...
                           font-size:16px;
                           font-family:Georgia;
                           text-shadow: 1px 1px 1px #666;">ALOTTED TASKS</font></center>';   
    
 
echo "<table style='width:60%'><tr><td>";
echo "<fieldset style='width:97%;'>";     
echo "<legend><h3>Showing pending Tasks alotted to".$assignedname." </h3>";
echo "</legend>";   
    ...
    $sql3="SELECT bio_leadtask.leadid,
         ...
         FROM bio_leadtask,
              ...
              bio_leads,
              bio_cust
       WHERE  bio_leadtask.teamid=$assignedfrm   AND
              bio_leadtask.duedate<='$currentdate' AND
              bio_leadtask.taskcompletedstatus=0        AND
              bio_leadtask.taskid=bio_task.taskid       AND
              bio_leadtask.teamid=bio_leadteams.teamid  AND
              bio_leadtask.leadid=bio_leads.leadid      AND
