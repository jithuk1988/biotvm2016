...
$sql1="SELECT * FROM  bio_internship_jobs";
  ...
  $sql2="SELECT * FROM bio_internship_jobenquiry WHERE cust_id='".$row1['cust_id']."'";
...
if($row2['district']!=""){
    $sql_2="SELECT *  FROM 
              ...
              WHERE bio_incidenthandlingoffcr.types=1
...
$officer=$row_2['officer'];
 ...
 $sql1_insert = "INSERT INTO bio_incidents(cust_id,type,source,enqtypeid,title,description,priority,
                                    ...
                                    mainmailcategory,submailcategory,emailtype,enq_id,email_message)
                    VALUES ('" . $cust_id . "',2,2,'" . $row1['enqtypeid'] . "',
                                  '" . $row1['title'] . "', '" . $row1['description'] . "',2,
                                    ...
                                    '" . $row1['submailcategory'] . "', '" .  $row1['emailtype']. "','" .  $row1['enq_id']. "','" . $row1['description'] . "')";                                           
