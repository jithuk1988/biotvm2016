...
$title = _('Feed Stock Sources ') . ' / ' . _('Maintenance');
...
echo '<p class="page_title_text"><img src="'.$rootpath.'/css/'.$theme.'/images/maintenance.png" title="' . _('Feedstocks')
	. '" alt="" />' . _('Feedstock Sources') . '</p>';
echo '<div class="page_help_text">' . _('Add / edit / delete Feedstock Types') . '</div><br />';
...
//	}
	...
	if (isset($SelectedType) AND $InputError !=1) {
		...
		$sql = "UPDATE bio_fssources
			       SET source='".$_POST['Feedstocks']."'
		...
		if ( $checkrow[0] > 0 ) {
			...
			// Add new record on submit
			 ...
			 $sql = "INSERT INTO bio_fssources(source)
	...
	if ($myrow[0]>0) {
		...
		$sql="DELETE FROM bio_fssources WHERE id='" . $SelectedType . "'";
