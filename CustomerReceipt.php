<?php
 $PageSecurity = 80;
/* $Id: CustomerReceipt.php 4575 2011-05-26 10:47:06Z daintree $ */
...
<?php
$msg='';
echo '<div id="dialog" title="Help box">
    <p>1. Please select a Bank Account firstly</p>
<p>2. Then search an existing customer with customer name or code</p>
<p>3. Select Customer from search result and enter amount and click Accept button</p>
<p>3. Then Click Accept and Process Batch button to complete the payment process.</p>
...
echo'<br><center><button id="opener"><b>Help</b></button></center>';
...
//		<td><input tabindex=13 type="text" name="Narrative" maxlength=30 size=32 value="' . $_POST['Narrative'] . '"></td></tr>';
	...
	echo '<br/><br/><input style="display:none" tabindex=12 type=submit name="GLEntry" value="' . _('Enter A GL Receipt') . '"><br /></div>';
