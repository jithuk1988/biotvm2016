...
SELECT docno,bio_document_master.document_name,0 AS c1,COUNT(*) as c2,bio_district.district,bio_municipality.municipality,bio_panchayat.name AS panchayath,bio_block.block,bio_corporation.corporation FROM bio_oldorderdoclist 
...
$sql_pending="
              ...
              SELECT docno,document_name,SUM(c1)+SUM(c2) AS tot1,0 AS tot2,district,municipality,panchayath,block,corporation FROM(
...
$sql_received="
               SELECT docno,document_name,0 AS tot1,SUM(c1)+SUM(c2) AS tot2,district,municipality,panchayath,block,corporation FROM(
...
SELECT docno,document_name,SUM(tot1) as count_not_recd,SUM(tot2) as count_recd,district,municipality,panchayath,block,corporation FROM(
                                                                                                                    
SELECT docno,document_name,tot1,tot2,district,municipality,panchayath,block,corporation FROM ($sql_pending 
) t4 GROUP BY docno
UNION ALL
SELECT docno,document_name,tot1,tot2,district,municipality,panchayath,block,corporation FROM ($sql_received
) t3 GROUP BY docno
