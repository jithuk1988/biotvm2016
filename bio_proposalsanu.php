...
echo '<input id="shwprint" type="button" name="shwprint" value="view/hide Quatations" onclick=panel2()>';
echo '<td colspan=2><p><div id="progress" class="centre">';
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
     ...
     document.getElementById("proposalgrid").innerHTML=xmlhttp.responseText; 
     
    }            
  } 
xmlhttp.open("GET","bio_proposalajax2.php",true);//alert(str1);
xmlhttp.send();        
} 
