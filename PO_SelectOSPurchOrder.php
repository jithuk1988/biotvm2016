...
echo '<br /><font size=1><div style="display:none" class="page_help_text">' ._('To search for purchase orders for a specific part use the part selection facilities below')
		.'</div> </font>';
echo '<br /><table style="display:none" class="selection"><tr>';
...
echo '<table style="display:none"><tr><td><input type=submit name="SearchParts" value="' . _('Search Parts Now') . '">';
...
//				   '</td><td class="tableheader">' . _('Receive') .
	...
	while ($myrow=DB_fetch_array($PurchOrdersResult)) {
		...
		} elseif ($myrow['status'] == 'Authorised' AND $myrow['allowprint'] == 0) {
