...
while ($ShipperRow=DB_fetch_array($ShipperResult)){
    ...
    echo '</select> ';
        ...
        echo '<input type="submit" name="SearchSuppliers" value=' . _('Select Now') . '"></td></tr>';//<input type="submit" name="SearchSuppliers" value=' . _('Select Now') . '">
...
//$_SESSION['PO'.$identifier]->Tel = $_POST['Tel'];
  ...
  echo '<tr><td>' . _('Supplier Contact') . ':</td><td><input type="text" name="SuppTel" size="31" maxlength="30" value="' . $_SESSION['PO'.$identifier]->SuppTel  . '"></td></tr>';
    echo '<tr><td>' . _('Address') . '  :</td>
        </td><td><input type="text" name="SuppDelAdd1" size="31" maxlength="40" value="' . $_POST['SuppDelAdd1'] . '"></td>
        </tr>';
