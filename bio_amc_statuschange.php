...
if($date==NULL){
    ...
    $sql_stupdate="UPDATE bio_cstask SET bio_cstask.completeddate='".FormatDateForSQL($date)."' , bio_cstask.status=1 
             ...
             //task transaction
                 ...
                 $sql_get_maxid="SELECT id from bio_cstask WHERE cstype=3 AND orderno='".$_GET['orderno']."' AND  despatch_id='".$_GET['amcno']."' AND taskno='".$_GET['taskno']."'";
    ...
    $result_trans=DB_query($sql_trans,$db);
                ...
                despatch_id='".$_GET['amcno']."' AND status=0 AND cstype=3";
