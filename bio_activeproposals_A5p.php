    ...
    include('includes/header.inc'); 
     include('includes/sidemenu.php');     
          echo '<center><font style="color: #333;
                           ...
                           font-size:16px;
                           font-family:Georgia;
                           text-shadow: 1px 1px 1px #666;">ACTIVE PROPOSALS</font></center>';   
...
//     include('includes/footer.inc');  
    ...
    function showactive(str1){
         ...
         window.location="bio_proposal_changestatus.php?lead=" + str1;
    }
    </script>';
...
//      
//      $date_diff= gregoriantojd($datearr2[1], $datearr2[2], $datearr2[0]) - gregoriantojd($datearr1[1], $datearr1[2], $datearr1[0]); 
//     $sql8="SELECT value from bio_changepolicy where  policyname='No of Days to became a proposal passive'";
