...
//==================================================================================================================//
 $sql1="SELECT bio_leads.leadid,
   ...
   $team=$myrow2['teamid'];
   $from=ConvertSQLDate($myrow2['assigneddate']);
...
//=============================================================================================================//  
   ...
   $pdf->addTextWrap($Left_Margin,$YPos-=$line_height+5,900,$FontSize+1,_('Full postal address                                  : Place :'), 'left'); 
   $pdf->addTextWrap($Left_Margin+215,$YPos-=$line_height-15,900,$FontSize+1,$place,'',0);  
   $string5="Door No :  ".$doorno."   Street : ".$street."";
   $pdf->addTextWrap($Left_Margin+183,$YPos-=$line_height+5,900,$FontSize+1,$string5,'',0);  
   $string5="Post :  ".$post."   Pincode : ".$pincode."";                   
   $pdf->addTextWrap($Left_Margin+183,$YPos-=$line_height+5,900,$FontSize+1,$string5,'',0);    
   $pdf->addTextWrap($Left_Margin+183,$YPos-=$line_height+5,900,$FontSize+1,_('Panchayath :..................................... Block..............................................'), 'left'); 
   $string3= "District :  ".$district."     State :  ".$state."";                           
   $pdf->addTextWrap($Left_Margin+183,$YPos-=$line_height+5,900,$FontSize+1,$string3,'',0);
   $pdf->addTextWrap($Left_Margin+183,$YPos-=$line_height+5,900,$FontSize+1,_('E-mail :'), 'left'); 
   $pdf->addTextWrap($Left_Margin+220,$YPos-=$line_height-15,900,$FontSize+1,$email,'',0); 
   $string= "Contact Telephone Numbers                 : ".$number."";   
   $pdf->addTextWrap($Left_Margin,$YPos-=$line_height+5,900,$FontSize+1,$string,'',0); 
   $pdf->addTextWrap($Left_Margin,$YPos-=$line_height+5,900,$FontSize+1,_('Nature of Institution                                : Government / Private / Charitable / Limited Company / LSGD.'), 'left'); 
   $pdf->addTextWrap($Left_Margin,$YPos-=$line_height+5,900,$FontSize+1,_('Head of the Organisation                       : Name :.......................................................................'), 'left');  
   $pdf->addTextWrap($Left_Margin+175,$YPos-=$line_height+5,900,$FontSize+1,_(': Designation : .............................................Contact No :.............................'), 'left'); 
   $pdf->addTextWrap($Left_Margin,$YPos-=$line_height+5,900,$FontSize+1,_('Contact person of the Organisation       : Name :'), 'left'); 
   $pdf->addTextWrap($Left_Margin+215,$YPos-=$line_height-15,900,$FontSize+1,$custname,'',0);
   $string1= ": Designation :......................................... Contact No : ".$mobno."";
   $pdf->addTextWrap($Left_Margin+175,$YPos-=$line_height+5,900,$FontSize+1,$string1,'',0);     
   $pdf->addTextWrap($Left_Margin,$YPos-=$line_height+5,900,$FontSize+1,_('Date of Application: .....................................'), 'left');
   $fs_date='  Date of Feasibility Study: '.$from.' - '.$to; 
   $pdf->addTextWrap($Left_Margin+200,$YPos,900,$FontSize+1,$fs_date, 'left');
