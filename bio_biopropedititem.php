...
$sql="SELECT categoryid,categorydescription from stockcategory
      ...
      //echo '<input type="hidden" name="prop" id="prop" value='.$flag2.'>'; 
      
      
echo "<table border=1 >";
echo "<tr>";
echo '<td><select name="caty" id="caty" style="width:300px">';
      ...
      echo '</select></td>';
              ...
              echo '<input type="hidden" name="flag2" id="flag2" value='.$prop.'>';
...
$('#search').click(function() {
  ...
  location.href="bio_biopropedititem.php?categoryid="+str+str2+str3+str4+str5;
});
...
function getresult(choose,first){
   // var prop=document.getElementById("prop").value; 
    //alert(prop); 
window.opener.location='bio_proposal.php?stockid1='+choose+'&first='+first+'&editlead='+<?php echo $lead;?>+'&prop_id=' + <?php echo $prop;?>;
window.close();
}


  // alert(str);  //  alert(str2);
