...
echo '<p class="page_title_text">' . ' ' . _('Work Order Approval') . '';
...
//--------------------------------------------------------------Start of Left Panel1  
    echo "<fieldset class='left_panel_1' style='display:none'>";     
...
echo '<tr><td>' . _('Season') . "*</td><td><select name='Season' readonly>";
...
echo"</td></tr>";
echo '<tr><td>' . _('Location') . "*</td><td><select name='Loccode' readonly>";
...
$StockID='';
echo '<tr><td>' . _('Item') . "*</td><td><select name='StockID' readonly id='woentrystockid' onchange='datagridload(this.value,".$SeasonID.")'>";
