...
if($_POST['regtype']==1){$title.=" of Consolidated ";}elseif($_POST['regtype']==2){$title.=" of Detailed ";}
...
function title($a){
echo "<font size='-1' style='margin-left:16%'><b>Total Count(".$a.")<b/></font>";     
}
//edited for report heading
if($_POST['regtype']==1)   {   
