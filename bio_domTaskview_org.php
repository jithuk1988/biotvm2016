...
echo"<fieldset style='width:600px;height:180px'>"; 
...
if($_GET['lead']!=''){
    ...
    $leadid=$_GET['lead'];    
       $sql="SELECT bio_leads.leadid, 
                    ...
                    bio_cust.cust_id,
                    bio_leads.enqtypeid  
              FROM  bio_leads,bio_cust,bio_leadteams,bio_leadsources,bio_district,bio_emp,www_users
