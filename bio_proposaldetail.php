...
echo"<td><input type='text' name='ExpectedDate' placeholder='DD/MM/YYYY'  id='date' class=date alt='".$_SESSION['DefaultDateFormat']. "' style='width:135px'></td></tr>";
echo"<tr></tr>";
 
echo"<tr><td>FS Charge :</td>";       
echo"<td><input type='text' name='Amount' id='amount' readonly value='$amount'></td></tr>";
