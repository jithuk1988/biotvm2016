...
echo$sql="UPDATE bio_approval SET taskcompletedstatus =1,taskcompleteddate='".date("Y-m-d")."' 
...
echo"<fieldset style='width:800px;height:auto'>"; 
...
$sql_spdisc="SELECT amount FROM bio_cpsubsidy WHERE leadid=$leadid AND cp_id='".$_SESSION['proposal']."' AND scheme=3 ";
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("totalgas").innerHTML=xmlhttp.responseText;  
    }
  } 
xmlhttp.open("GET","bio_changegasout.php?gasout=" + str + "&leadid=" +str1,true);
xmlhttp.send();  
}
