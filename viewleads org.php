...
/*  $sql="SELECT bio_cust.cust_id AS custid,  
 ...
 $sql="
SELECT DISTINCT  bio_leads.leadid AS leadid, bio_cust.cust_id AS custid, bio_cust.custname AS custname, 
    ...
    bio_cust.district AS districtid, bio_leads.leaddate AS leaddate, bio_leads.remarks AS remarks, bio_advance.amount AS amount,bio_leads.grade, 
