...
//echo $_SESSION['Transfer']->TransferItem[0]->Quantity;
echo $_POST['Quantity'];
...
/*All inputs must be sensible so make the stock movement records and update the locations stocks */
		...
		if ($_SESSION['ProhibitNegativeStock']==1 AND $QtyOnHandPrior<$_SESSION['Transfer']->$_POST['Quantity']) {
		...
		$SQL = "INSERT INTO stockmoves (stockid,
			...
			VALUES (
					...
					'" . round(-$_POST['Quantity'],$_SESSION['Transfer']->TransferItem[0]->DecimalPlaces)  . "',
...
/*Insert the StockSerialMovements and update the StockSerialItems  for controlled items*/
		...
		$SQL = "UPDATE locstock SET quantity = quantity - '" . $_POST['Quantity'] . "'
				WHERE stockid='" . $_SESSION['Transfer']->TransferItem[0]->StockID . "'
				AND loccode='" . $_SESSION['Transfer']->StockLocationFrom . "'";
		...
		prnMsg(_('An inventory transfer of').' ' . $_SESSION['Transfer']->TransferItem[0]->StockID . ' - ' . $_SESSION['Transfer']->TransferItem[0]->ItemDescription . ' '. _('has been created from').' ' . $_SESSION['Transfer']->StockLocationFrom . ' '. _('to') . ' ' . $_SESSION['Transfer']->StockLocationTo . ' '._('for a quantity of').' ' . $_POST['Quantity'],'success');
