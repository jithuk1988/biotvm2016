<?php
/* $Id: SalesTypes.php 4594 2011-06-11 07:26:47Z daintree $*/
...
if (isset($_POST['submit'])) {
	...
	if (isset($SelectedType) AND $InputError !=1) {
		...
		if ( $checkrow[0] > 0 ) {
			...
			// Add new record on submit ....................................................................................................................16/09/201
            ...
            if($_POST['type']==1){                 
   $baid=$_POST['TypeAbbrev']; 
   
            $sql1="INSERT INTO bio_businesasociatemaster(batype_id,businessasociatetypes) VALUES('$baid','".$_POST['Sales_Type']."')";
...
if (! isset($_GET['delete'])) {
	...
	echo '<tr><td>' . _('Sales Type') . ':</td>
			<td><input type="Text" name="Sales_Type" value="' . $_POST['Sales_Type'] . '"></td></tr>';
  //==============================================================================================================================
  
       echo'<tr><td>Business Type</td>';
     echo'<td><select name="type"> <option>   </option>
                                   <option value="1">Business associate</option>
              </select></td></tr>';  
     echo'<tr><td><a href="SalesPeople.php">' . _('Business Associate Types') . '</a></td></tr>';
 //===============================================================================================================================
